...
- REST API - Import `restful-web-services` into Eclipse as Maven Project. Run `RestfulWebServicesApplication` as a Java Application. Check Authentication and REST API Sections for executing REST APIs.
